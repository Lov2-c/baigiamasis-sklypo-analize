# =========================================================
# FAILAS: kulturos_paveldo_procentine_analize.py
# PASKIRTIS:
# Apskaičiuoti, kokia kiekvieno sklypo dalis (%) patenka
# į kultūros paveldo poligonus ir jų apsaugos zonas.
# =========================================================
...
if __name__ == "__main__":
    ...
    sluoksniai = [
        {
            "failas": r"01_duomenys/papildomi/kulturos_paveldas/kvr_poligonai.gpkg",
            "csv": r"06_rezultatai/kvr_poligonu_proc.csv",
            "stulpelis": "kvr_poligonu_proc"
        },
        {
            "failas": r"01_duomenys/papildomi/kulturos_paveldas/kvr_apsaugos_zonos.gpkg",
            "csv": r"06_rezultatai/kvr_apsaugos_zonu_proc.csv",
            "stulpelis": "kvr_apsaugos_zonu_proc"
        }
    ]
    ...
    print("\nKultūros paveldo sluoksnių analizė baigta.")