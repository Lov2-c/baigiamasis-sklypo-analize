# =========================================================
# FAILAS: 07_random_forest_1000.py
# PASKIRTIS:
# RandomForestClassifier modelio bandymas su nauju
# 1000 sklypų modelio failu.
#
# TARGET:
...
def paleisti_random_forest_modeli_1000():
    """
    Funkcija:
    1. nuskaito 1000 sklypų modelio duomenis
    ...
    print("=" * 80)
    print("RANDOM FOREST 1000 REZULTATAI")
    print("=" * 80)
    ...
    # ---------------------------------------------------------
    svarbos_failas = "06_rezultatai/random_forest_1000_pozymiu_svarba.csv"
    svarbos_df.to_csv(svarbos_failas, index=False, encoding="utf-8-sig")

    rezultatu_df = pd.DataFrame([{
        "modelis": "RandomForest_1000",
    ...
    rezultatu_failas = "06_rezultatai/random_forest_1000_rezultatai.csv"
...
if __name__ == "__main__":
    paleisti_random_forest_modeli_1000()