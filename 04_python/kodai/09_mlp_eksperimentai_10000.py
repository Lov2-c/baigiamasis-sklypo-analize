# =========================================================
# FAILAS: 09_mlp_eksperimentai_10000.py
# PASKIRTIS:
# Atlikti 24 skirtingus MLPClassifier bandymus su 10000
...
def paleisti_mlp_eksperimentus_10000():
    """
    Pagrindinė funkcija:
    1. paruošia duomenis
    ...
    print("=" * 80)
    print("PRASIDEDA MLP 10000 EKSPERIMENTAI")
    print("=" * 80)
    ...
    isvedimo_failas = "06_rezultatai/mlp_10000_bandymu_lentele.csv"
    ...
    top5_failas = "06_rezultatai/mlp_10000_top5_bandymu_lentele.csv"
...
if __name__ == "__main__":
    paleisti_mlp_eksperimentus_10000()