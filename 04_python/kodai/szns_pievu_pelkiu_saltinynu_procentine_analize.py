# =========================================================
# FAILAS: szns_pievu_pelkiu_saltinynu_procentine_analize.py
# PASKIRTIS:
# Apskaičiuoti, kokia kiekvieno sklypo dalis (%) patenka
# į pelkių, šaltinynų ir pievų/ganyklų sluoksnius.
# =========================================================
...
if __name__ == "__main__":
    ...
    sluoksniai = [
        {
            "failas": r"01_duomenys/papildomi/szns/pelkes_tpdr.gpkg",
            "csv": r"06_rezultatai/pelkiu_proc.csv",
            "stulpelis": "pelkiu_proc"
        },
        {
            "failas": r"01_duomenys/papildomi/szns/saltinynai_tpdr.gpkg",
            "csv": r"06_rezultatai/saltinynu_proc.csv",
            "stulpelis": "saltinynu_proc"
        },
        {
            "failas": r"01_duomenys/papildomi/szns/pievos_ganyklos_tpdr.gpkg",
            "csv": r"06_rezultatai/pievu_ganyklu_proc.csv",
            "stulpelis": "pievu_ganyklu_proc"
        }
    ]
    ...
    print("\nPelkių, šaltinynų ir pievų/ganyklų analizė baigta.")