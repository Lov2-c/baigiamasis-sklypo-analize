...
if __name__ == "__main__":
    ...
    # -----------------------------------
    # 3. PASIIMAME TIK PIRMUS 1000 SKLYPŲ
    # -----------------------------------
    mini_sklypai = tvarkingi_sklypai.sample(n=1000, random_state=42).copy()

    print("Mini-datasetui atsitiktinai parinkta 1000 tvarkingų sklypų.")
    print()
    ...
    # 7. IŠSAUGOME Į CSV
    # -----------------------------------
    isvedimo_kelias = "06_rezultatai/mini_dataset_bp_1000.csv"
