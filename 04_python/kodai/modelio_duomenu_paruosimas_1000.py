# =========================================================
# FAILAS: modelio_duomenu_paruosimas_1000.py
# PASKIRTIS:
# Paruošti 1000 sklypų modelio duomenų failą,
...
if __name__ == "__main__":
    ivesties_failas = "06_rezultatai/mini_dataset_bp_1000_pilnas.csv"
    isvesties_failas = "06_rezultatai/modelio_duomenys_1000.csv"

    df = pd.read_csv(ivesties_failas, encoding="utf-8-sig")

    print("Nuskaitytas pradinis 1000 sklypų dataset.")
